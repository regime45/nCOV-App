...
public class global extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.global:
                Intent amphibiansActivityIntentss = new Intent(global.this, global.class);

                startActivity(amphibiansActivityIntentss);
                return true;

            case R.id.local:
                Intent intentss = new Intent(global.this, Covidupdates.class);
                startActivity(intentss);
                return true;
            case R.id.ph:
                Intent sss = new Intent(global.this, ph.class);
                startActivity(sss);
                return true;
